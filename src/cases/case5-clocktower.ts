  ...
  rooms: {
    ...
    stairs: {
      ...
      things: {
        ...
        x: {
          ...
          sprite: "towerSlitWindow",
          on: "#",
          spriteIf: [{ when: "clue:shadow", sprite: "towerSlitWindowDark" }],
    ...
    clockwork: {
      ...
      things: {
        ...
        w: {
          name: "Fönstret",
          sprite: "towerSlitWindowDark",
          on: "#",
          talk: ["Ett smalt fönster högt upp i urverket.", "Det står på glänt. Det drar kallt härifrån…"],
        },
        c: {
  ...
  goals: [
    ...
    },
    {
      ...
      hints: [
        ...
        { text: "Högst upp i mitten, längst in i en smal nisch, finns ett fönster. Vad syns därute?", skipWhen: "clue:shadow" },
      ],
    },
    {
    ...
    },
    {
      ...
      hints: [
        ...
        { text: "Något har fastnat vid fönstret högst upp.", skipWhen: "clue:caveMap" },
