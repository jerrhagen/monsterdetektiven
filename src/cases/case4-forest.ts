...
export const case4: Case = {
  ...
  rooms: {
    edge: {
        ...
        h: {
          ...
          talkIf: [
            ...
            },
            {
              ...
              talk: ["Du kan spåren! Nu går du inte vilse.", "Stigen till bäcken är till höger.", "Akta dig för vargen!"],
            },
            {
              when: EDGE_CLUES,
              talk: [
      ...
      monsters: [{ type: "patroller", sprite: "forestWolf", path: [[16, 3], [16, 8]], speed: 30 }],
      doors: [
        {
          at: "right",
          to: "stream",
        ...
        { at: "bottom", lockedText: "Vi kan inte gå hem än. Djuren behöver oss!" },
      ],
    },
    ...
    stream: {
      ...
      monsters: [{ type: "sleeper", sprite: "mossjatte", at: [7, 2], wakeRadius: 3 }],
      doors: [
        { at: "left", to: "edge" },
        {
          at: "top",
  ...
  finale: [
    ...
    { enter: "jatte", sprite: "mossjatte", from: [10, 11], to: [10, 9] },
    { frame: "jatte", index: 1 },
    {
      say: "Mossjätten",
      lines: [
  ...
  goals: [
    ...
    },
    {
      ...
      hints: [
        { text: "Stigen in i skogen är till höger. Men Hilma sa något om spår…", skipWhen: "tracks-learned" },
        ...
        { text: "Du kan spåren! Gå in på stigen till höger.", when: "tracks-learned" },
      ],
    },
    {
    ...
    },
    {
      ...
      hints: [
        { text: "Stigen till svampringen är längst upp. Men någon vaktar den…", skipWhen: "ring-open" },
        ...
        { text: "Trattis släppte förbi dig! Gå upp mot svampringen – tyst förbi jätten.", when: "ring-open" },
      ],
    },
    {
