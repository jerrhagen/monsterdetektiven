  ...
  goals: [
    ...
    },
    {
      ...
      hints: [
        ...
        { text: "Titta noga vid dörren till höger. Har något fastnat där?", skipWhen: "clue:blueFluff" },
    ...
    },
    {
      ...
      hints: [
        { text: "Dörren till gården är till höger. Men den är låst…", skipWhen: "backdoor-open" },
        ...
        { text: "Dörren är öppen! Gå ut till höger.", when: "backdoor-open" },
      ],
    },
    {
    ...
    },
    {
      ...
      hints: [
        { text: "Källarluckan är längst ner på gården. Men den är låst…", skipWhen: "cellar-key" },
        ...
        { text: "Du har nyckeln! Gå ner genom luckan längst ner.", when: "cellar-key" },
      ],
    },
    {
